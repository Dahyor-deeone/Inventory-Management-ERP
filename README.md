...
The Inventory Management ERP is a lightweight enterprise resource planning application designed to streamline inventory management processes for small and medium-sized enterprises (SMEs).
...
### **Key Objectives**
- Improve visibility of inventory across operational workflows.
- Structure inbound and outbound inventory transactions.
- Apply FEFO principles to inventory allocation.
- Maintain centralised inventory records.
...
Centralised view of inventory and stock information.

**⬇️ Inbound Inventory**

Records incoming inventory transactions, including:
...
Inventory is managed with consideration for product expiry dates so that inventory approaching expiry can be prioritised for outbound transactions.

**🏢 Supplier Management**

Provides functionality for adding and managing suppliers.
...
Provides an administrative interface for managing application users.

**⚙️ Control Centre**

Provides centralised administrative/operational controls within the application.

**↩️ Transaction Management**

Includes functionality for reviewing and managing inbound and outbound transactions, including void transactions.
